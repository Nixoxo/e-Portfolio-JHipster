(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('carOwnerProjectApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-carOwnerProjectApp-error');
                var entityKey = httpResponse.headers('X-carOwnerProjectApp-params');
                if (errorHeader) {
